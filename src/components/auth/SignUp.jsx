  ...
  return (
    <div>
      <div className="w-[300px] mx-auto flex justify-center items-center py-5">
       ...
       <div className="">
       <h2 className="text-3xl font-bold text-[#dd443f]">Unity Space</h2>
       <p>Create new account with signup.</p>
       </div>
      </div>
      <div className="hero">
        <div className="hero-content shadow-[0_0_5px_rgba(0,0,0,0.25)] w-full md:w-2/6 flex-col lg:flex-row-reverse rounded">
